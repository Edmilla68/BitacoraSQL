...
left join CALW12SQLCORP.NPT9_bd_trit.dbo.tb_tipo_identificacion_bien as h                
...
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
GO  
 ALTER procedure  Listar_DetFacturaByNroFac_Optimizado
...
inner join CALW12SQLCORP.NPT9_bd_trit.dbo.tb_tipo_identificacion_bien as h            
...
inner join CALW12SQLCORP.NPT9_bd_trit.dbo.tb_tipo_identificacion_bien as f                    
...
inner join CALW12SQLCORP.NPT9_bd_trit.dbo.tb_tipo_identificacion_bien as e              
...
from CALW12SQLCORP.NPT9_bd_trit.dbo.tb_mov_aux_MANT as a 
                                                                                                                                                                                                             
inner join CALW12SQLCORP.NPT9_bd_trit.dbo.tb_item_gasto as b on a.dc_item_gasto = b.dc_item_gasto
                                                                                                                                                                     
inner join CALW12SQLCORP.NPT9_bd_trit.dbo.tb_persona as c on a.dc_rut_acreedor = c.dc_rut
                                                                                                                                                                             
inner join CALW12SQLCORP.NPT9_bd_trit.dbo.tb_centro_costo as d on a.dc_centro_costo_imputacion = d.dc_centro_costo
                                                                                                                                                    
inner join CALW12SQLCORP.NPT9_bd_inst.dbo.tb_sucursal_INST as e on a.dc_sucursal_imputacion = e.dc_sucursal
...
from CALW12SQLCORP.NPT9_bd_trit.dbo.tb_mov_aux_MAN1 as a 
                                                                                                                                                                                                             
inner join CALW12SQLCORP.NPT9_bd_trit.dbo.tb_item_gasto as b on a.dc_item_gasto = b.dc_item_gasto
                                                                                                                                                                     
inner join CALW12SQLCORP.NPT9_bd_trit.dbo.tb_persona as c on a.dc_rut_proveedor = c.dc_rut
...
from CALW12SQLCORP.NPT9_bd_trit.dbo.tb_mov_aux_comb as a 
...
from CALW12SQLCORP.NPT9_bd_trit.dbo.tb_mov_aux_MARE as a 
...
from CALW12SQLCORP.NPT9_bd_trit.dbo.tb_mov_aux_SERT as a 
