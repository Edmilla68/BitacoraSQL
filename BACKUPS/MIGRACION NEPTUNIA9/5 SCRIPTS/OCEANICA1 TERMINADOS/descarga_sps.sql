----                                                                                                                                                                                                                                                           
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
ALTER procedure FACT_SERIESUCURSAL_ListarSucursal        
...
----                                                                                                                                                                                                                                                           
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
ALTER procedure ROCKY_LISTAR_NRO_DE_CNTR_DESCARGA_VACIOS
...
Insert Into CALW12SQLCORP.NEPT9_bd_nept.dbo.ROCKY_INFORME_DESCARGA (NAVVIA11,TOTAL,INGRESADOS,NO_INGRESADOS,VACIOS,INGRESO_VACIOS,EMAIL,NAVE,VIAJE,LLEGADA)
                                                                                                            
Select @NAVVIA, 0, 0, 0, 0, IngVacios=count(a.codcon04), 'N', @NAVE, @VIAJE, @LLEGADA
                                                                                                                                                                        
From ADREGEIR15 a, ADMOVCTR09 b
                                                                                                                                                                                                                              
Where a.navvia11 = @NAVVIA and tipmov15 = 'I' and a.codcon04 = b.codcon04 and a.nrosec09 = b.nrosec09 and codbol09 = 'MT'
...
ALTER procedure sp_Consultar_DetOrdenSerByIdOrden              
