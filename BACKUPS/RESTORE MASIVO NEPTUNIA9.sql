...
RESTORE DATABASE NPT9_bd_actf         FROM DISK = '\\lulas-system001\backup2\bd_actf.Bak' WITH  FILE = 1,  
...
RESTORE DATABASE NPT9_bd_fulp         FROM DISK = '\\lulas-system001\backup2\bd_fulp.Bak' WITH  FILE = 1,  
...
RESTORE DATABASE NPT9_bd_hist_nept    FROM DISK = '\\lulas-system001\backup2\bd_hist_nept.Bak' WITH  FILE = 1,  
...
RESTORE DATABASE NPT9_bd_inst         FROM DISK = '\\lulas-system001\backup2\bd_inst.Bak' WITH  FILE = 1,  
...
RESTORE DATABASE NPT9_bd_kint         FROM DISK = '\\lulas-system001\backup2\bd_kint.Bak' WITH  FILE = 1,  
...
RESTORE DATABASE NPT9_bd_nep2         FROM DISK = '\\lulas-system001\backup2\bd_nep2.Bak' WITH  FILE = 1,  
...
RESTORE DATABASE NPT9_bd_nept         FROM DISK = '\\lulas-system001\backup2\bd_nept.Bak' WITH  FILE = 1,  
...
RESTORE DATABASE NPT9_bd_seguridad    FROM DISK = '\\lulas-system001\backup2\bd_seguridad.Bak' WITH  FILE = 1,  
...
RESTORE DATABASE NPT9_bd_trit         FROM DISK = '\\lulas-system001\backup2\bd_trit.Bak' WITH  FILE = 1,  
...
RESTORE DATABASE NPT9_Datawarehouse   FROM DISK = '\\lulas-system001\backup2\Datawarehouse.Bak' WITH  FILE = 1,  
...
RESTORE DATABASE NPT9_RRHH            FROM DISK = '\\lulas-system001\backup2\RRHH.Bak' WITH  FILE = 1,  
...
RESTORE DATABASE NPT9_RSCONCAR        FROM DISK = '\\lulas-system001\backup2\RSCONCAR.Bak' WITH  FILE = 1,  
