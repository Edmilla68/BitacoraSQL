...
USE [master]
ALTER DATABASE [bd_actf] SET SINGLE_USER WITH ROLLBACK IMMEDIATE
RESTORE DATA BASE bd_actf         FROM DISK = '\\lulas-system001\backup2\bd_actf.Bak' WITH  FILE = 1,  
...
ALTER DATABASE [bd_actf] SET MULTI_USER
GO

USE [master]
ALTER DATABASE [bd_fulp] SET SINGLE_USER WITH ROLLBACK IMMEDIATE
RESTORE DATA BASE bd_fulp         FROM DISK = '\\lulas-system001\backup2\bd_fulp.Bak' WITH  FILE = 1,  
...
NOUNLOAD,  REPLACE,  STATS = 5
ALTER DATABASE [bd_fulp] SET MULTI_USER
GO

USE [master]
ALTER DATABASE [bd_hist_nept] SET SINGLE_USER WITH ROLLBACK IMMEDIATE
RESTORE DATA BASE bd_hist_nept    FROM DISK = '\\lulas-system001\backup2\bd_hist_nept.Bak' WITH  FILE = 1,  
...
NOUNLOAD,  REPLACE,  STATS = 5
ALTER DATABASE [bd_hist_nept] SET MULTI_USER
GO

USE [master]
ALTER DATABASE [bd_inst] SET SINGLE_USER WITH ROLLBACK IMMEDIATE
RESTORE DATA BASE bd_inst         FROM DISK = '\\lulas-system001\backup2\bd_inst.Bak' WITH  FILE = 1,  
...
NOUNLOAD,  REPLACE,  STATS = 5
ALTER DATABASE [bd_inst] SET MULTI_USER
GO

USE [master]
ALTER DATABASE [bd_kint] SET SINGLE_USER WITH ROLLBACK IMMEDIATE
RESTORE DATA BASE bd_kint         FROM DISK = '\\lulas-system001\backup2\bd_kint.Bak' WITH  FILE = 1,  
...
NOUNLOAD,  REPLACE,  STATS = 5
ALTER DATABASE [bd_kint] SET MULTI_USER
GO

USE [master]
ALTER DATABASE [bd_nep2] SET SINGLE_USER WITH ROLLBACK IMMEDIATE
RESTORE DATA BASE bd_nep2         FROM DISK = '\\lulas-system001\backup2\bd_nep2.Bak' WITH  FILE = 1,  
...
NOUNLOAD,  REPLACE,  STATS = 5
ALTER DATABASE [bd_nep2] SET MULTI_USER
GO

USE [master]
ALTER DATABASE [bd_nept] SET SINGLE_USER WITH ROLLBACK IMMEDIATE
RESTORE DATA BASE bd_nept         FROM DISK = '\\lulas-system001\backup2\bd_nept.Bak' WITH  FILE = 1,  
...
NOUNLOAD,  REPLACE,  STATS = 5
ALTER DATABASE [bd_nept] SET MULTI_USER
GO

USE [master]
ALTER DATABASE [bd_seguridad] SET SINGLE_USER WITH ROLLBACK IMMEDIATE
RESTORE DATA BASE bd_seguridad    FROM DISK = '\\lulas-system001\backup2\bd_seguridad.Bak' WITH  FILE = 1,  
...
NOUNLOAD,  REPLACE,  STATS = 5
ALTER DATABASE [bd_seguridad] SET MULTI_USER
GO

USE [master]
ALTER DATABASE [bd_trit] SET SINGLE_USER WITH ROLLBACK IMMEDIATE
RESTORE DATA BASE bd_trit         FROM DISK = '\\lulas-system001\backup2\bd_trit.Bak' WITH  FILE = 1,  
...
NOUNLOAD,  REPLACE,  STATS = 5
ALTER DATABASE [bd_trit] SET MULTI_USER
GO


USE [master]
ALTER DATABASE [Datawarehouse] SET SINGLE_USER WITH ROLLBACK IMMEDIATE
RESTORE DATA BASE Datawarehouse   FROM DISK = '\\lulas-system001\backup2\Datawarehouse.Bak' WITH  FILE = 1,  
...
RESTORE DATA BASE RRHH            FROM DISK = '\\lulas-system001\backup2\RRHH.Bak' WITH  FILE = 1,  
...
USE [master]
ALTER DATABASE [RSCONCAR] SET SINGLE_USER WITH ROLLBACK IMMEDIATE
RESTORE DATA BASE RSCONCAR        FROM DISK = '\\lulas-system001\backup2\RSCONCAR.Bak' WITH  FILE = 1,  
...
NOUNLOAD,  REPLACE,  STATS = 5
ALTER DATABASE [RSCONCAR] SET MULTI_USER
GO
