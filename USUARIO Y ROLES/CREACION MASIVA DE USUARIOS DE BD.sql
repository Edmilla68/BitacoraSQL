a
CREATE LOGIN [DOMNEP\jorosillo] FROM WINDOWS WITH DEFAULT_DATABASE=[master], DEFAULT_LANGUAGE=[us_english]
GO
   ...
   BEGIN
      print @name
				  ...
				  DECLARE @SQLquery AS VARCHAR(2048)
				   ...
				   SELECT @SQLquery = @SQLquery + 'CREATE USER [DOMNEP\jorosillo]  FOR LOGIN [DOMNEP\jorosillo]; '
